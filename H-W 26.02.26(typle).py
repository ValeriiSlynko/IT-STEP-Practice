...
name_city = ('Kharkiv','Kyiv','Odessa','Lviv','Dnipro','Poltava','Kharkiv','Kyiv')
...
def similar_elements (tuple_num_1:tuple, tuple_num_2:tuple) -> list:
    ...
    for a, b in zip(tuple_num_1, tuple_num_2):
        if a==b:
            result.append(a)

    return result

tuple_num_1 = (1,3,5,7,9,11,12,13,14,15)    # створено вручну, але можна через "import random"
tuple_num_2 = (2,4,6,8,10,11,12,13,14,15)   # створено вручну, але можна через "import random"

print("\nПерший кортеж: ", tuple_1)
print("Другий кортеж: ", tuple_2)
print("Список однакових елементів та індексів по кортежах: ", similar_elements(tuple_num_1, tuple_num_2))