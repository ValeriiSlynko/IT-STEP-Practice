...
words = ["Valery", "Lyudmila", "Vera", "Suzanna", "Ihor", "Svetlana", "Elena", "Sergey", "Alyona", "Ivan", "Maria"]
letter = "a"

print(f"\nСлова зі списку в яких літера '{letter}' найбільше зустрічається, це: " , *count_letter(letter, words))
